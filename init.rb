...
Redmine::Plugin.register :redmine_agile do
  ...
  menu :top_menu, :issues_gantt, { :controller => 'gantt', :action => 'show', :set_filter => 1, :f => ['status_id', 'fixed_version_id', 'version_status'], :op => { :status_id => 'o', :fixed_version_id => '*', :version_status => 'open' } }, :caption => :label_gantt
