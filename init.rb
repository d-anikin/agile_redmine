...
Redmine::Plugin.register :redmine_agile do
  ...
  menu :top_menu, :issues_backlog, { :controller => 'issues', :action => 'index', :set_filter => 1, :f => ['fixed_version_id'], :op => { :fixed_version_id => '!*' }, :group_by => 'project', :per_page => 100}, :caption => :label_backlog
  menu :top_menu, :agile_boards, { :controller => 'agile_boards', :action => 'index', :set_filter => 1, :f => ['fixed_version_id'], :op => { :fixed_version_id => '*' } }, :caption => :label_agile
